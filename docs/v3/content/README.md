...
- 第一阶段已落地 `items`、`revisions`、`tags`、`content_tags`、`content_relation`、`content_outbox_events`、Studio 管理接口、公开读取接口和 RabbitMQ 事件投递。
- 下一阶段实现优先级为 search/indexer -> attachments/comments。
