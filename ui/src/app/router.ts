  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'audits', name: 'studio-audits', component: () => import('@/pages/studio/StudioAuditsPage.vue'), meta: { pageMeta: { i18nPrefix: 'audits' } } },
        { path: 'profile', redirect: '/account/profile' },
        { path: 'change-password', redirect: '/studio' },
        { path: 'settings', name: 'studio-settings', component: () => import('@/pages/studio/StudioSettingsPage.vue'), meta: { pageMeta: { i18nPrefix: 'settings' } } },
      ],
    },
    {
      path: '/:pathMatch(.*)*',
