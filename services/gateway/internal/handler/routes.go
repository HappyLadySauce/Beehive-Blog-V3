...
func RegisterHandlers(server *rest.Server, serverCtx *svc.ServiceContext) {
	...
	studioContentRoutes := []rest.Route{
		...
		},
		{
			...
			Handler: content.ContentRelationListHandler(serverCtx),
		},
		{
			// Create content relation
			Method:  http.MethodPost,
			Path:    "/items/:content_id/relations",
			Handler: content.ContentRelationCreateHandler(serverCtx),
		},
		{
			// Delete content relation
			Method:  http.MethodDelete,
			Path:    "/items/:content_id/relations/:relation_id",
			Handler: content.ContentRelationDeleteHandler(serverCtx),
		},
		{
